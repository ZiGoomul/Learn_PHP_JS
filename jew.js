...
function updateDisplay() {
	...
	document.getElementById("allTimeDicksSucked").innerHTML = "(Всего сорвал брущатки: " + beautify(allTimeShekeli) + ")";
		...
		// Tier 1 
	document.getElementById("buyGoyMercButton").innerHTML = "<b>Бендеровец.</b><br />" + beautify(goyMercPrice) + " Брущатки (+" + beautify(goyMercDPS) + "БзС)<br />Куплено: <b>"+beautify(goyMercCounter)+"</b>";
	document.getElementById("buyCheapJewButton").innerHTML = "<b>Бендеровец с палкой.</b><br />" + beautify(cheapJewPrice) + " Брущатки (+" + beautify(cheapJewMultiplier) + "БзК,+" + beautify(cheapJewDPS) + "БзС)<br />Куплено: <b>"+beautify(cheapJewCounter)+"</b>";
	document.getElementById("buyVacuumCleanerButton").innerHTML = "<b>Бендеровец с коктейлем.</b><br />" + beautify(vacuumCleanerPrice) + " Брущатки (+" + beautify(vacuumCleanerMultiplier) + "БзК,+" + beautify(vacuumCleanerDPS) + "БзС)<br />Куплено: <b>"+beautify(vacuumCleanerCounter)+"</b>";
	...
	document.getElementById("buyCreditCompanyButton").innerHTML = "<b>Канал чесных нововостей</b><br />" + beautify(creditCompanyPrice) + " Брущатки (+" + beautify(creditCompanyMultiplier) + "БзК,+" +  beautify(creditCompanyDPS) + "БзС)<br />Куплено: <b>"+beautify(creditCompanyCounter)+"</b>";
